...
export default function Page() {
  return (
    ...
    >
      ...
      <Text>
        Představ si svět, kde při nakupování online nevzniká žádný odpad. Svět,
        kde po každém nákupu nemusíš vyhazovat krabici a starat se o hromadu
        výplně, u které nikdy nevíš, co s ní.
      </Text>
