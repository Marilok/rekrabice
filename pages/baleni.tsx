import { Anchor, Container, List, Text, Title, TypographyStylesProvider, Code, Mark, Table } from "@mantine/core";
    ...
    <LandingPageWrapper>
      ...
      <Container size="xl">
        <div>
          ...
          <Text>
            Na většině webových stránek naleznete <Code>/o-nas</Code> nebo <Code>/kontakt</Code> stránku, kde
            návštěvníci najdou informace o dané osobě nebo firmě a nebo kontaktní informace. Na stránce
            <Code color="green">/baleni</Code> se návštěvníci dozvědí, jak vaše společnost přemýšlí o
        ...
        <div>
          ...
          <Text>
            ...
            udržitelné obaly prioritou. Stránka <Code color="green">doména.cz/baleni</Code> pomáhá lidem poznat, že
            vám na tom záleží.
          </Text>
        </div>
        <div>
          ...
          <Text>
            ...
            <Code color="green">doména.cz/baleni</Code>. Tuto adresu URL můžete také přesměrovat na
            existující stránku na vašem webu. <br />
